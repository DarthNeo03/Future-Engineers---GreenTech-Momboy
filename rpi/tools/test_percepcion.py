...
CASES = [
    ("pasillo_1000", [frontal(1150, -650, 350), lateral(350, -300, 1150),
                      lateral(-650, -300, 1150)], 0.0,
     {"izq": (350, 30), "der": (650, 45), "ancho": (1000, 50),
      "frente": (1150, 70), "fin_izq": (None, 0), "fin_der": (None, 0)}),
    ...
    ("girado_12", [frontal(1150, -650, 350), lateral(350, -300, 1150),
                   lateral(-650, -300, 1150)], 12.0,
    ...
    ("girado_m8", [frontal(1150, -650, 350), lateral(350, -300, 1150),
                   lateral(-650, -300, 1150)], -8.0,
