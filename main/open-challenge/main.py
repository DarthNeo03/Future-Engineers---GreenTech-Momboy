#!/usr/bin/env python3
"""
main.py — Piloto WRO 2026, OPEN CHALLENGE.

Tres vueltas a la pista vacia, contando las esquinas por las lineas del piso y
parando dentro de la seccion de meta. NO mira pilares: el reto de obstaculos
es otro programa, en main/obstacle-challenge/.
