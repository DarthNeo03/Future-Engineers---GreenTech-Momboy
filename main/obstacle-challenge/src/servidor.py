        ...
        try:
            for k, v in args.items():
                if k == "armar":
                    ...
                    # TCS. Sirve para probar el conteo y la maniobra de
                    # esquina en el banco, sin empujar el carro sobre la linea.
                ...
                elif k == "probar_rescate":
                    # Dispara el rescate de esquina a mano, para verlo en el
                    # banco sin tener que meter el carro en un rincon.
                    r.forzar_rescate()
                elif k == "boton":
                    ...
                    # de start sin cablear nada. ?boton=corta (o ?boton=larga)
